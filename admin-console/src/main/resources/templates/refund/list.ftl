                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input class="layui-input" id="outTradeNo" type="text" placeholder="请输入支付订单号">
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label">退款订单号</label>
                        <div class="layui-input-inline">
                            <input class="layui-input" id="refundOutTradeNo" type="text" placeholder="请输入退款订单号">
                        </div>
                    </div>
                    <div class="layui-inline">
...
<table id="table" class="layui-table" lay-data="{ page:true, id:'table'}" lay-filter="table">
    ...
    <tr>
        ...
        <th lay-data="{field:'outTradeNo',width:200}">支付订单号</th>
        <th lay-data="{field:'refundOutTradeNo',width:200}">退款订单号</th>
        ...
        <th lay-data="{field:'refundStatus',width:120}">退款状态</th>
    ...
    function searchOrder() {
        ...
        table.reload('table', {
            ...
            where: { //设定异步数据接口的额外参数，任意设
                ...
                refundOutTradeNo: $("#refundOutTradeNo").val(),
        ...
        table.on('tool(table)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'detail') { //查看
                var refundOutTradeNo = data.refundOutTradeNo;
                var index = layer.open({
                    type: 2,
                    content: '/refund/view?refundOutTradeNo=' + refundOutTradeNo,
                    area: ['640px', '500px'],
                    offset: '30px'
                });
